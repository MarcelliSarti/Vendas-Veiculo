object FRMmanutVeic: TFRMmanutVeic
  Left = 0
  Top = 0
  ...
  object BTNpesquisaModelo: TBitBtn
    Left = 560
    Top = 55
    Width = 41
    Height = 25
    ...
    NumGlyphs = 2
    TabOrder = 0
    OnClick = BTNpesquisaModeloClick
  end
  ...
  object FDQuery1: TFDQuery
    ...
    Left = 680
    Top = 48
    object FDQuery1Cod_manut: TFDAutoIncField
      FieldName = 'Cod_manut'
      Origin = 'Cod_manut'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object FDQuery1Cod_veiculo: TIntegerField
  ...
  object qryItem: TFDQuery
    IndexFieldNames = 'Cod_manut'
    MasterSource = DataSource1
    MasterFields = 'Cod_manut'
    DetailFields = 'Cod_manut'
    Connection = DataModule1.FDConnection1
    Transaction = FDTransaction1
    FetchOptions.AssignedValues = [evCache]
    FetchOptions.Cache = [fiBlobs, fiMeta]
    SQL.Strings = (
      'select * from itens_manut'
  ...
  object FDQueryProduto: TFDQuery
    ...
    Left = 664
    Top = 8
    object FDQueryProdutoCod_Produto: TFDAutoIncField
    ...
    object FDQueryProdutoImposto: TBCDField
      FieldName = 'Imposto'
      Required = True
      Precision = 5
      Size = 2
