...
uses Umodulo, UpesquisaVendedor, UpesquisaVendedor2, Urelatorio;
...
procedure TFRMcadVendedor.BTNrelatClick(Sender: TObject);
var path: string;
begin
path := ExtractFilePath(Application.ExeName);
FRMrelatorios.frxReportVendedor.LoadFromFile(path + 'RelatorioVendedor.fr3');
FRMrelatorios.frxReportVendedor.ShowReport();
end;
